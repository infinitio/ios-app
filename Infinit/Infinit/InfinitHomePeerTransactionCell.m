...
- (void)awakeFromNib
{
  ...
  self.left_button.titleLabel.minimumScaleFactor = 0.5f;
  ...
  self.right_button.titleLabel.adjustsFontSizeToFitWidth = YES;
  self.right_button.titleLabel.minimumScaleFactor = 0.5f;
