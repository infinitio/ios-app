...
+ (NSDictionary *)alphabetizedDictionaryFromObjects:(NSArray *)objects
    ...
    NSString *nonLetterPlaceholder = [placeholder length] ? placeholder : @"#";
    for (id object in objects) {
        NSString *firstLetter = [self keyFromObject:object usingKeyPath:@"lastName" result:nil placeholder:nonLetterPlaceholder maxLength:1 validCharacterSet:[NSCharacterSet letterCharacterSet]];      
      if([firstLetter isEqualToString:@"#"])
      {
        firstLetter = firstLetter = [self keyFromObject:object usingKeyPath:@"firstName" result:nil placeholder:nonLetterPlaceholder maxLength:1 validCharacterSet:[NSCharacterSet letterCharacterSet]];
      }
